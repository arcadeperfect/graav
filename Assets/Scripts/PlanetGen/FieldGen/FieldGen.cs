...
// //                 normalizer = 1f / (tex_width * tex_width),
// //                 frequency = frequency,
// //                 amplitude = amplitude,  // Keep original amplitude for now
// //                 seed = seed
// //             };
// //
// //             JobHandle jobHandle = generationJob.Schedule(tex_width * tex_width, 64);
...
// //                 float nze = noise.snoise(pos);
// //
// //                 // Scale the noise displacement to be resolution-independent
// //                 // Convert amplitude from UV space back to pixel space for the distance calculation
// //                 float pixelAmplitude = amplitude * texWidth;
// //
// //                 // Determine pixel value based on radius
// //                 float val = (normalizedDistanceSquared < (radius * radius) + (nze * pixelAmplitude) ? 1.0f : 0f);
// //
// //                 fieldData[index] = val;
// //
// //                 var mult = 0.02f;
