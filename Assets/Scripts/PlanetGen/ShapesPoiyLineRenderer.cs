...
namespace PlanetGen
{
    ...
    public class ShapesPolylineRenderer : MonoBehaviour
    {
        ...
        [Range(1, 100)]
        public int maxPolylinesRendered = 50;
        ...
        /// <summary>
        /// Update polylines from marching squares data
        /// Call this when new polyline data is available
        /// </summary>
            ...
            MarchingSquaresCPU.PolylineData polylineData)
        {
            ...
            for (int i = 0; i < colliderData.Length && processedCount < maxPolylinesRendered; i++)
            {
                ...
                {
                    var point = polylineData.AllPoints[data.StartIndex + j];
                ...
                if (enableFill && closedLoops && data.PointCount >= 3)
                {
            ...
            {
                Debug.Log($"[ShapesPolylineRenderer] Updated {processedCount} polylines in {stopwatch.ElapsedMilliseconds}ms");
            }
        }
        ...
        /// </summary>
        public void UpdatePolylinesFromRanges(MarchingSquaresCPU.PolylineData polylineData)
        {
        ...
        private void UpdateRenderBounds()
        {
            ...
            var frustumHeight = 2.0f * Mathf.Abs(mainCamera.transform.position.z) * Mathf.Tan(mainCamera.fieldOfView * 0.5f * Mathf.Deg2Rad);
